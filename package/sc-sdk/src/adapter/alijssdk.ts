import { 
    ...
    ScanOption, ChoseImageOpt, UploadImageOpt, RecordOpt, VoiceOpt,
} from '../interface';
...
export default class AliSdk extends AbsJsSdk {
    ...
    const {authUrl,sdkConfig}=this.option
        if (sdkConfig){
            ...
            //     }
            //  )
             this.apJsSdk.error(function(res){
                 console.log(res)
                throw "apJsSdk load error"
            });
        }  
    ...
    //                     ...recordOpt
    //                 }
    //                 this.apJsSdk.getLocation(recordOpt, (res)=>{
    //                     resolve(_that.getSuccess(res));
    //                 });
    //                 break;
    //         }
