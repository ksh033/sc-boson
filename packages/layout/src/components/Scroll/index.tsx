...
const ensureWithinLimits = (value: any, min: any, max: any) => {
...
function isEventPosOnDomNode(event: any, domNode: any) {
  const nodeClientRect = domNode.getBoundingClientRect()
  return isEventPosOnLayout(event, nodeClientRect)
}

function isEventPosOnLayout(event: any, layout: any) {
  return (
...
class CustomScroll extends Component<CustomScrollProps, any> {
  ...
  scrollRatio: any
  hasScroll: any
  scrollHandleHeight: any
  startDragHandlePos: any
  startDragMousePos: any
  ...
  customScrollRef = createRef<any>()
  innerContainerRef = createRef<any>()
  customScrollbarRef = createRef<any>()
  scrollHandleRef = createRef<any>()
  contentWrapperRef = createRef<any>()

  adjustFreezePosition = (prevProps: any) => {
  ...
  updateScrollPosition = (scrollValue: any) => {
    const innerContainer = this.getScrolledElement()
  ...
  isMouseEventOnCustomScrollbar = (event: any) => {
  ...
  isMouseEventOnScrollHandle = (event: any) => {
  ...
  calculateNewScrollHandleTop = (clickEvent: any) => {
  ...
  adjustCustomScrollPosToContentPos = (scrollPosition: any) => {
    this.setState({
      scrollPos: scrollPosition
    })
  }

  onScroll = (event: { currentTarget: { scrollTop: any } }) => {
    if (this.props.freezePosition) {
      return
    }
  ...
  onHandleDrag = (event: { preventDefault: () => void; pageY: number }) => {
  ...
  onHandleDragEnd = (e: { preventDefault: () => void }) => {
    this.setState({
      onDrag: false
    })
    e.preventDefault()
  ...
  enforceMinHandleHeight = (calculatedStyle: { height: any; top: any }) => {
          ...
          {this.hasScroll ? (
            <div className={"positioning"}>
              <div
                ...
                key="scrollbar"
              >
                <div ref={this.scrollHandleRef} className={'custom-scroll-handle'} style={scrollHandleStyle}>
