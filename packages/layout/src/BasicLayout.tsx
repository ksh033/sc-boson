...
export type BasicLayoutProps = Partial<RouterTypes> &
  ...
  HeaderProps & {
    ...
    footerRender?: WithFalse<(props: HeaderProps, defaultDom: React.ReactNode) => React.ReactNode>;
...
const BaseLayout: React.FC<BasicLayoutProps> = (props) => {
  ...
  const { breadcrumb = {}, menuData = [] } = menuInfoData;
  ...
  useDeepCompareEffect(() => {
    ...
    const infoData = getMenuData(route?.routes || [], menu, undefined, menuDataRender);
